...
<div class="row">
	<div class="col-md-12">
		<h4>
			...
			Data Laporan Penjualan <?= $bulan_tes[$_POST['bln']];?> <?= $_POST['thn'];?> - Metode Pembayaran: <?= $_POST['metode_pembayaran'];?>
			<?php }elseif(!empty($_GET['hari'])){?>
			Data Laporan Penjualan <?= $_POST['hari'];?> - Metode Pembayaran: <?= $_POST['metode_pembayaran'];?>
			<?php }else{?>
